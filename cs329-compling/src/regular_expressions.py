...
def turn_1b(res: SimpleNamespace):
    ...
    if any(phone):
        ...
        print("S: Sorry, I didn't catch that. Goodbye!")
...
def turn_3a(res: SimpleNamespace):
    ...
    if res.in_phone_version in res.d_iphone_v.keys():
        years_old = now.year - res.d_iphone_v[res.in_phone_version]
        s = 'S: iphone {} is about {} years old'.format(res.in_phone_version, years_old)
    else:
        s = "Sorry, I don't seem to know this model"
    print(s)
